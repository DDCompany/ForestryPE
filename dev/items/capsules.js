...
LiquidRegistry.registerItem("forestryBiomass", {id: 325, data: 0}, {id: ItemID.bucketBiomass, data: 0});
LiquidRegistry.registerItem("forestryEthanol", {id: 325, data: 0}, {id: ItemID.bucketEthanol, data: 0});

LiquidRegistry.registerItem("water", {id: ItemID.waxCapsuleEmpty, data: 0}, {id: ItemID.waxCapsuleWater, data: 0});
LiquidRegistry.registerItem("forestryJuice", {id: ItemID.waxCapsuleEmpty, data: 0}, {
    id: ItemID.waxCapsuleJuice,
    data: 0
});
LiquidRegistry.registerItem("forestryHoney", {id: ItemID.waxCapsuleEmpty, data: 0}, {
    id: ItemID.waxCapsuleHoney,
    data: 0
});
LiquidRegistry.registerItem("forestrySeedoil", {id: ItemID.waxCapsuleEmpty, data: 0}, {
    id: ItemID.waxCapsuleSeedoil,
    data: 0
});
LiquidRegistry.registerItem("forestryBiomass", {id: ItemID.waxCapsuleEmpty, data: 0}, {
    id: ItemID.waxCapsuleBiomass,
    data: 0
});
LiquidRegistry.registerItem("forestryEthanol", {id: ItemID.waxCapsuleEmpty, data: 0}, {
...
LiquidRegistry.registerItem("forestryJuice", {id: ItemID.canEmpty, data: 0}, {id: ItemID.canJuice, data: 0});
LiquidRegistry.registerItem("forestryHoney", {id: ItemID.canEmpty, data: 0}, {id: ItemID.canHoney, data: 0});
LiquidRegistry.registerItem("forestrySeedoil", {id: ItemID.canEmpty, data: 0}, {id: ItemID.canSeedoil, data: 0});
LiquidRegistry.registerItem("forestryBiomass", {id: ItemID.canEmpty, data: 0}, {id: ItemID.canBiomass, data: 0});
LiquidRegistry.registerItem("forestryEthanol", {id: ItemID.canEmpty, data: 0}, {id: ItemID.canEthanol, data: 0});
...
LiquidRegistry.registerItem("forestryJuice", {id: ItemID.refractoryEmpty, data: 0}, {
    id: ItemID.refractoryJuice,
    data: 0
});
LiquidRegistry.registerItem("forestryHoney", {id: ItemID.refractoryEmpty, data: 0}, {
    id: ItemID.refractoryHoney,
    data: 0
});
LiquidRegistry.registerItem("forestrySeedoil", {id: ItemID.refractoryEmpty, data: 0}, {
    id: ItemID.refractorySeedoil,
    data: 0
});
LiquidRegistry.registerItem("forestryBiomass", {id: ItemID.refractoryEmpty, data: 0}, {
    id: ItemID.refractoryBiomass,
    data: 0
});
LiquidRegistry.registerItem("forestryEthanol", {id: ItemID.refractoryEmpty, data: 0}, {
