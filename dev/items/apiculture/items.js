...
Item.createItem("kitPickaxe", "Pickaxe kit", {name: "kitPickaxe", meta: 0}, {});

IDRegistry.genItemID("kitShovel");
Item.createItem("kitShovel", "Shovel kit", {name: "kitShovel", meta: 0}, {});
...
Callback.addCallback("PostLoaded", function () {
    ...
    Recipes.addShaped({id: ItemID.kitPickaxe, count: 1, data: 0}, [
        ...
        "pc ",
        "   "
    ], ['p', ItemID.bronzePickaxe, -1, 'c', ItemID.carton, -1]);

    Recipes.addShaped({id: ItemID.kitShovel, count: 1, data: 0}, [
        "   ",
        "pc ",
        "   "
    ], ['p', ItemID.bronzeShovel, -1, 'c', ItemID.carton, -1]);
