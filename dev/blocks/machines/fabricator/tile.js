MachineRegistry.register(BlockID.fabricator, {
    ...
    tick: function () {
        ...
        if (this.data.temperature >= 0) {
            ...
            let recipe = RecipeRegistry.getFabricatorRecipe(input);
            if (recipe) {
        ...
        // }
        //
        // if (this.data.energy >= 200 && (slotGlass.id === 12 || slotGlass.id === 20 || slotGlass.id === 102 )) {
        //     this.data.energy -= 200;
        //     this.data.temperature += 5;
        //     if (this.data.temperature > this.TEMPERATURE_MAX) {
        //         this.data.temperature = this.TEMPERATURE_MAX;
        //     }
        //
        ...
        // }
        //
        // if (this.data.temperature === 0 && this.liquidStorage.getAmount("forestryGlass")) {
        //     this.liquidStorage.getLiquid("forestryGlass", this.liquidStorage.getAmount("forestryGlass"));
        // }
        //
        // if (this.liquidStorage.getAmount("forestryGlass")) {
        //     let input = {};
        //
        //     for (let i = 0; i < 9; i++) {
        //         let slot = this.container.getSlot("slotInput" + i);
