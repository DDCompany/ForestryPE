...
var BackpackRegistry = {
    ...
    prototypes: {},
    /**
     * Объект, который содержит стандартные интерфейсы.
     */
    guis: {},
    /**
    ...
    register: function (id, obj) {
        ...
        if (!gui) {
            ...
            if (!this.guis[guiKey]) {
                ...
                BackpackRegistry.addSlotsToGui(gui, slots, isValidFunc, obj.inRow, obj.slotsCenter !== false);
                this.guis[guiKey] = gui;
            }
        }
    ...
    getGUIKey: function (proto) {
        return proto.slots + " " + proto.inRow + " " + proto.slotsCenter;
    },
    ...
    openGuiFor: function (id, data, notUpdateData) {
        ...
        if (prototype) {
            ...
            container.openAs(prototype.gui || this.guis[this.getGUIKey(prototype)]);
            return data;
        }
